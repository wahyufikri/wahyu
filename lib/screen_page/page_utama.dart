...
import 'package:wahyu/screen_page/page_detail.dart';
import 'package:wahyu/screen_page/page_edit.dart';
import 'package:wahyu/screen_page/page_insert.dart';
...
class _PageUtamaState extends State<PageUtama> {
  ...
  Future<void> getEmployees() async {
    try {
      var response = await http.get(Uri.parse('http://192.168.0.116/pegawaiDB/getPegawai.php'));
  ...
  Future<void> deleteEmployee(String id) async {
    try {
      var response = await http.post(
        Uri.parse('http://192.168.0.116/pegawaiDB/deletePegawai.php'),
        body: {'id': id},
      );
      var jsonData = json.decode(response.body);
          ...
          Expanded(
            child: filteredEmployeeList != null
              ...
              itemBuilder: (context, index) {
                ...
                : Center(
              child: CircularProgressIndicator(color: Colors.red), // Changed to red
            ),
          ),
        ],
      ),
